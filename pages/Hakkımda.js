        ...
        return (
            <div>
                ...
                <p>
                    ...
                    &nbsp;&nbsp;&nbsp;Güncel olarak front-end developer olarak <a rel="noreferrer" target="_blank" style="font-weight:700" href="https://www.personaclick.com/">personaclick</a> bünyesinde çalışmaktayım ve önde gelen e ticaret markalarına çeşitli çalışmalarla, kazançlarını ve kullanıcı deneyimlerini olumlu yönde arttırmaya yönelik geliştirmeler yapmaktayım.
                </p>
                </div>:
                <div className='main'>
                <h2>ABOUT ME</h2>
                ...
                &nbsp;&nbsp;&nbsp;Currently working as a front-end developer at <a rel="noreferrer" target="_blank" style="font-weight:700" href="https://www.personaclick.com/">personaclick</a> and developing different kind of projects for different types of eCommerce websites and love the way watching how they turning to revenues.
                </p>
            </div>       
                }
